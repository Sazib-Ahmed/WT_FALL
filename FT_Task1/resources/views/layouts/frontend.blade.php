        ...
        <div class="col-md-8">
            <div class="card">
              ...
              <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="m_name" class="col-md-4 col-form-label text-md-end">{{ __('TELL US YOUR NAME') }}</label>

                            <div class="col-md-6">
                                <input id="m_name" type="text" class="form-control @error('m_name') is-invalid @enderror" name="m_name" value="{{ old('m_name') }}" requirequired autocomplete="m_name"red>
                        ...
                        <div class="row mb-3">
                            <label for="m_email" class="col-md-4 col-form-label text-md-end">{{ __('ENTER YOUR EMAIL') }}</label>

                            <div class="col-md-6">
                                <input id="m_email" type="m_email" class="form-control @error('m_email') is-invalid @enderror" name="m_email" value="{{ old('m_email') }}" required autocomplete="m_email">
                        ...
                        <div class="row mb-3">
                            <label for="m_phone" class="col-md-4 col-form-label text-md-end">{{ __('ENTER PHONE NUMBER') }}</label>

                            <div class="col-md-6">
                                <input id="m_phone" type="number" class="form-control @error('m_phone') is-invalid @enderror" name="m_phone" required autocomplete="m_phone">
                        ...
                        <div class="row mb-3">
                            <label for="m_message" class="col-md-4 col-form-label text-md-end">{{ __('MESSAGE') }}</label>

                            <div class="col-md-6">
                                <input id="m_message" type="text" class="form-control" name="m_message" required autocomplete="m_message">
                            </div>
                        </div>
